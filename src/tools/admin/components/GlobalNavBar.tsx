...
<>
    {/* Wide nav bar */}
        <nav  className='hidden md:flex !justify-between flex-center gap-3 h-fit w-full px-5 py-3 bg-[var(--main)] border-b border-[var(--border)] shadow-lg' style={{boxShadow: '0 4px 24px 0 var(--shadow-color)', zIndex: 20}}>
            <div className=''>
